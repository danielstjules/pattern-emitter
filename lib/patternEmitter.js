...
/**
 * Removes the listener from the specified type. If type is a RegExp, it
 * matches any RegExp instance with the same expression. Emits a
...
/**
 * Removes all listeners for the given type. If type is a RegExp, it matches
 * the RegExp instance with the same expression. Emits a 'removeListener' event
 * for each removed listener. Returns an instance of itself.
 *
 * @param {*} type The event type, including a RegExp, to remove
 *
 * @returns {PatternEmitter} This instance
